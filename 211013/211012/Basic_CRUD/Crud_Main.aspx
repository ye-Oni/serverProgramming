...
&nbsp;&nbsp;
            <asp:Button ID="Button2" runat="server" Text="데이터수정 " OnClick="Button2_Click" />
&nbsp;&nbsp;
            <asp:Button ID="Button3" runat="server" Text="데이터삭제 " OnClick="Button3_Click" />
&nbsp;
            <asp:Button ID="Button4" runat="server" Text="데이터보기 " OnClick="Button4_Click" />
            <br />
            <br />
            <br />
